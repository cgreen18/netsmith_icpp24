...
CMD="python3 scipy_mip/run_scipy_mip.py --model_file ../gurobi/files/models/autotop_r${1}_p4_ll${size_str}_${obj_str}_simple.lp --out_map_name my_${1}r_4p_${size_str}ll_${obj_str}_topo.map ${BASE_FLAGS}"
